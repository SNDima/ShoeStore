...
class ShoeListViewModel : ViewModel() {
    ...
    private fun loadShoes() {
        _shoes.value = listOf(
            ...
            Shoe("Day One Safety Sublite", 12.5, "Reebok",
                ""),
            Shoe("Sawhorse 6\" Composite Safety Toe", 7.0, "Timberland",
